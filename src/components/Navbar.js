    ...
    <header className="sticky top-0 z-40 w-full border-b border-slate-800/60 bg-slate-950/70 backdrop-blur-md transition-all duration-300">
      <div className="mx-auto flex max-w-7xl h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <a href="#" className="flex items-center gap-2.5 group">
          <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-400 to-blue-600 p-0.5 shadow-[0_0_15px_rgba(34,211,238,0.3)] transition-transform duration-300 group-hover:scale-105">
            <div className="flex h-full w-full items-center justify-center rounded-[10px] bg-slate-950">
              ...
              <svg
                ...
                stroke="currentColor"
                strokeWidth="2.5"
                className="h-5.5 w-5.5 text-cyan-400"
              >
          ...
          <span className="text-xl font-bold tracking-tight text-white space-x-1">
            <span>VWT</span>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            onClick={onOpenCart}
            className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-slate-800 bg-slate-900/50 hover:bg-slate-800/80 hover:text-cyan-400 text-slate-300 transition-colors duration-200"
          >
            <ShoppingBag className="h-5 w-5" />
            {cartItemsCount > 0 && (
              <span className="absolute -top-1.5 -right-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-cyan-500 text-[10px] font-bold text-slate-950 animate-pulse">
                {cartItemsCount}
              </span>
            )}
          </button>
          ...
          {user ? (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-900/50 px-3.5 py-2 hover:bg-slate-800/80 transition-all text-sm font-medium text-white"
              >
            ...
            <button
              onClick={onOpenLogin}
              className="flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-4.5 py-2 text-sm font-semibold text-slate-950 shadow-[0_0_15px_rgba(6,182,212,0.2)] hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all cursor-pointer"
            >
          ...
          <button
            ...
            className="md:hidden flex h-10 w-10 items-center justify-center rounded-xl border border-slate-800 bg-slate-900/50 text-slate-300"
          >
